...
<div class="content">
<div class="title">添加数据 [ <a href="/Form">返回列表</a> ]</div>
<div id="result" class="result none"></div>
<script type="text/javascript" charset="utf-8" src="/Public/Js/editor/kindeditor.js"></script>
<script type="text/javascript">
    KE.show({
        id : 'content_1' //TEXTAREA输入框的ID
   });
</script>
<form method='post' id="form1" name="form1" action="/Form/insert"  enctype="multipart/form-data">
